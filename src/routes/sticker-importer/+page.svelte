	...
	>
		...
		<div class="m-10 flex flex-col items-center gap-4 text-center">
			...
			<button
				...
				class="cursor-pointer rounded-full bg-teal-800/60 px-8 py-2 font-semibold frosted-glass transition-colors hover:bg-teal-600/60"
			>
				Select
			</button>
		</div>
		...
		<button
			...
			class="{percentage === -1
				? 'bg-teal-800/60 hover:bg-teal-600/60'
